...
export const employees: Employee[] = [
  { id:1,  name:'Ava Patel',       dept:'Finance',       manager:'Lisa Huang (CFO)',    role:'Director',        eid:'E-1042', fte:1, spend:318.42, tokens:142, gpu:5.2,  prompts:1283, apps:['openai','copilot_m365'],                    policy:'Compliant', variance:18,  alloc:250, center:'FIN-100', risk:52, entity:'US HQ' },
  { id:2,  name:'Marcus Chen',     dept:'Engineering',   manager:'Ray Torres (CTO)',    role:'Staff Engineer',  eid:'E-2190', fte:1, spend:842.13, tokens:460, gpu:18.4, prompts:4870, apps:['openai','anthropic','vertex_ai'],           policy:'Review',    variance:41,  alloc:600, center:'ENG-220', risk:77, entity:'US HQ' },
  { id:3,  name:'Sofia Ramirez',   dept:'Revenue Cycle', manager:'Pat Owen (VP Ops)',   role:'Analyst',         eid:'E-1441', fte:1, spend:184.19, tokens:88,  gpu:1.3,  prompts:921,  apps:['copilot_m365'],                             policy:'Compliant', variance:-6,  alloc:200, center:'RCM-310', risk:19, entity:'US HQ' },
  { id:4,  name:'Daniel Brooks',   dept:'Marketing',     manager:'Rina Park (CMO)',     role:'Manager',         eid:'E-3022', fte:1, spend:509.76, tokens:210, gpu:7.7,  prompts:2128, apps:['openai','adobe_firefly'],                   policy:'Review',    variance:64,  alloc:300, center:'MKT-410', risk:71, entity:'US HQ' },
  { id:5,  name:'Priya Nair',      dept:'HR',            manager:'Tom Bell (CHRO)',     role:'BP Lead',         eid:'E-1880', fte:1, spend:126.31, tokens:61,  gpu:0.8,  prompts:640,  apps:['copilot_m365'],                             policy:'Compliant', variance:-12, alloc:150, center:'HR-120',  risk:14, entity:'US HQ' },
  { id:6,  name:'Ethan Walker',    dept:'Finance',       manager:'Lisa Huang (CFO)',    role:'FP&A Manager',    eid:'E-1067', fte:1, spend:392.84, tokens:174, gpu:6.1,  prompts:1662, apps:['openai','copilot_m365'],                    policy:'Compliant', variance:22,  alloc:325, center:'FIN-120', risk:35, entity:'US HQ' },
  ...
  { id:8,  name:'Noah Kim',        dept:'Operations',    manager:'Dana Fox (COO)',      role:'Ops Manager',     eid:'E-5118', fte:1, spend:221.64, tokens:102, gpu:1.8,  prompts:804,  apps:['copilot_m365','google_gemini'],              policy:'Compliant', variance:5,   alloc:225, center:'OPS-510', risk:23, entity:'US HQ' },
  { id:9,  name:'Chloe Martin',    dept:'Engineering',   manager:'Ray Torres (CTO)',    role:'Senior Engineer', eid:'E-2204', fte:1, spend:714.88, tokens:398, gpu:14.2, prompts:3960, apps:['anthropic','github_copilot'],                policy:'Review',    variance:29,  alloc:550, center:'ENG-220', risk:61, entity:'US HQ' },
  { id:10, name:'James Wright',    dept:'Finance',       manager:'Lisa Huang (CFO)',    role:'Controller',      eid:'E-1091', fte:1, spend:198.55, tokens:90,  gpu:1.5,  prompts:780,  apps:['copilot_m365'],                             policy:'Compliant', variance:-3,  alloc:200, center:'FIN-100', risk:22, entity:'US HQ' },
  { id:11, name:'Lily Okonkwo',    dept:'Engineering',   manager:'Ray Torres (CTO)',    role:'ML Engineer',     eid:'E-2299', fte:1, spend:988.40, tokens:520, gpu:22.1, prompts:5120, apps:['anthropic','vertex_ai','openai'],           policy:'Review',    variance:52,  alloc:650, center:'ENG-230', risk:80, entity:'US HQ' },
  { id:12, name:'Tom Hartley',     dept:'Operations',    manager:'Dana Fox (COO)',      role:'Process Lead',    eid:'E-5201', fte:1, spend:142.77, tokens:68,  gpu:0.9,  prompts:544,  apps:['copilot_m365'],                             policy:'Compliant', variance:-8,  alloc:175, center:'OPS-510', risk:16, entity:'US HQ' },
];
